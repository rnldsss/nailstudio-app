{{-- Nama file: resources/views/discount.blade.php --}}
<!DOCTYPE html>
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  ...
  <title>
    Discount Nail Art and Cosmetics - Nail Art Theme
  </title>
  
  {{-- Tetap menggunakan CDN untuk Tailwind dan Font Awesome --}}
 ...
 <body class="bg-pink-light text-[#1A1A1A]">
  <div class="max-w-7xl mx-auto px-4 py-10 md:py-16 py-8 bg-pink-100 p-4">
    ...
    <div>
      ...
      {{-- PERUBAHAN: Menggunakan helper url() Laravel untuk navigasi --}}
      <a href="{{ url('/shop-sale') }}"> 
  ...
  <div class="w-full border-t border-pink bg-pink-light py-4 overflow-hidden">
    ...
    <div class="flex space-x-8 text-pink-600 text-sm md:text-base font-semibold whitespace-nowrap scrolling-wrapper">
      <div class="flex items-center space-x-2"><i class="far fa-clock text-lg"></i><span>Fast Delivery</span></div>
      <div class="flex items-center space-x-2"><i class="fas fa-hand-sparkles text-lg"></i><span>Genuine Nail Art Products</span></div>
      <div class="flex items-center space-x-2"><i class="far fa-star text-lg"></i><span>Google Trusted Store</span></div>
      <div class="flex items-center space-x-2"><i class="fas fa-map-marker-alt text-lg"></i><span>Australian Owned</span></div>
      <div class="flex items-center space-x-2"><i class="fas fa-box-open text-lg"></i><span>Free Shipping</span></div>
      <div class="flex items-center space-x-2"><i class="fas fa-headset text-lg"></i><span>Customer Support</span></div>
      <div class="flex items-center space-x-2"><i class="far fa-clock text-lg"></i><span>Fast Delivery</span></div>
      <div class="flex items-center space-x-2"><i class="fas fa-hand-sparkles text-lg"></i><span>Genuine Nail Art Products</span></div>
      <div class="flex items-center space-x-2"><i class="far fa-star text-lg"></i><span>Google Trusted Store</span></div>
      <div class="flex items-center space-x-2"><i class="fas fa-map-marker-alt text-lg"></i><span>Australian Owned</span></div>
