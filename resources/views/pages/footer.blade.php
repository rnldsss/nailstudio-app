...
<head>
  ...
  <style>
    ...
    .payment-icons img { filter: none; opacity: 1; }
  </style>
</head>
<body>
  <div id="footer-wrapper" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-20">
    ...
    <div class="bg-white rounded-lg p-6 sm:p-8 mb-14 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-0">
      <div>
        <h2 class="font-semibold text-lg leading-6 text-[#1a1a1a]">Join our newsletter</h2>
      ...
      <form action="{{ route('footer.subscribe') }}" method="POST" class="flex w-full sm:w-auto gap-3">
        ...
        <input type="email" name="email"
               class="flex-grow sm:flex-grow-0 sm:w-[220px] rounded-md border border-gray-300 px-4 py-2 text-sm text-[#1a1a1a] placeholder:text-[#4b4b4b] focus:outline-none focus:ring-2 focus:ring-black"
               placeholder="Enter your email" required>
        <button type="submit"
                class="bg-black text-white rounded-md px-5 py-2 text-sm font-semibold hover:bg-gray-900 transition">
          Subscribe
        </button>
      </form>
    </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-y-10 gap-x-8 text-sm">
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a href="#" class="text-[#1a1a1a] hover:text-gray-700"><i class="fab fa-facebook-f text-lg"></i></a>
            <a href="#" class="text-[#1a1a1a] hover:text-gray-700"><i class="fab fa-instagram text-lg"></i></a>
          </div>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-[#4b4b4b]">
            <li><a href="#" class="hover:underline">Discount</a></li>
        ...
        <div>
          ...
          <ul class="space-y-2 text-[#4b4b4b]">
            <li><a href="#" class="hover:underline">Nail polish</a></li>
            <li><a href="#" class="hover:underline">Nail tools</a></li>
            <li><a href="#" class="hover:underline">Nail care</a></li>
            <li><a href="#" class="hover:underline">Nail art kits</a></li>
          </ul>
        </div>
