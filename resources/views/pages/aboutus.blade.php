...
<body>
  ...
  <nav class="relative z-10 flex items-center justify-between px-4 sm:px-6 md:px-10 lg:px-16 py-4 text-white text-sm font-semibold">
    <div class="flex items-center space-x-8">
      <a class="flex items-center space-x-2" href="{{ url('/') }}">
        <img alt="Logo" class="w-8 h-8" src="{{ asset('uploads/logo.jpg') }}" />
    ...
    <div class="hidden md:flex items-center space-x-6 text-xs font-semibold">
      ...
      <a href="https://maps.app.goo.gl/ig16vaeSuRgFhv9QA" target="_blank" class="flex items-center space-x-1 hover:text-gray-300" rel="noopener noreferrer">
  ...
  <main class="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-10 lg:px-16 py-32">
    ...
    <a href="{{ url('/aboutus/detail') }}" class="mt-8 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold px-6 py-2 rounded inline-block text-center">
      About Us
    </a>
  </main>
