<!DOCTYPE html>
{{-- Kode PHP Session dan DB Access dipindahkan ke Controller --}}
{{-- Catatan: File ini biasanya hanya berisi komponen Navbar, 
   tapi karena kode Anda mencakup <head> dan <body>, saya menyertakan tag tersebut --}}
...
<head>
    ...
    <script>
        // Menggunakan fungsi url() Laravel untuk API base
